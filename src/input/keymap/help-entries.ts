...
export const HELP_MODE_LABELS: { modeId: ModeId; label: string }[] = [
  ...
  { label: 'Workspace picker', modeId: 'modal.project-picker.filtering' },
  { label: 'Workspace picker — filter', modeId: 'modal.project-picker.filtering' },
  { label: 'Workspace name', modeId: 'modal.project-name' },
  { label: 'Create workspace', modeId: 'modal.create-project' },
