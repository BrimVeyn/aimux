...
/**
 * Capability gating `setBytesEnabled` / `serializeBuffer` — the raw PTY byte
 * stream the GUI host feeds to xterm.js. Additive: the TUI never asks for it,
 * and a daemon without it simply never streams bytes.
 */
export const IPC_CAPABILITY_BYTE_STREAM = 'byteStream'
