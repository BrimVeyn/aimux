...
export const theme: Theme = {
  ...
  colors: {
    ...
    'diffEditor.insertedLineBackground': '#238636',
    'diffEditor.insertedTextBackground': '#3fb950',
    'diffEditor.removedLineBackground': '#da3633',
    'diffEditor.removedTextBackground': '#ff7b72',
    ...
    'editor.findMatchHighlightBackground': '#f2cc60',
    'editor.focusedStackFrameHighlightBackground': '#2ea043',
    'editor.foldBackground': '#6e7681',
    'editor.foreground': '#e6edf3',
    'editor.lineHighlightBackground': '#6e7681',
    'editor.linkedEditingBackground': '#2f81f7',
    'editor.selectionBackground': '#272b31',
    'editor.selectionHighlightBackground': '#3fb950',
    'editor.stackFrameHighlightBackground': '#bb8009',
    'editor.wordHighlightBackground': '#6e7681',
    'editor.wordHighlightBorder': '#6e7681',
    'editor.wordHighlightStrongBackground': '#6e7681',
    'editor.wordHighlightStrongBorder': '#6e7681',
    ...
    'editorBracketMatch.background': '#3fb950',
    ...
    'editorIndentGuide.activeBackground': '#e6edf3',
    'editorIndentGuide.background': '#e6edf3',
    'editorInlayHint.background': '#8b949e',
    'editorInlayHint.foreground': '#7d8590',
    'editorInlayHint.paramBackground': '#8b949e',
    'editorInlayHint.paramForeground': '#7d8590',
    'editorInlayHint.typeBackground': '#8b949e',
    ...
    'list.activeSelectionBackground': '#6e7681',
    'list.activeSelectionForeground': '#e6edf3',
    'list.focusBackground': '#388bfd',
    'list.focusForeground': '#e6edf3',
    'list.highlightForeground': '#2f81f7',
    'list.hoverBackground': '#6e7681',
    'list.hoverForeground': '#e6edf3',
    'list.inactiveFocusBackground': '#388bfd',
    'list.inactiveSelectionBackground': '#6e7681',
    'list.inactiveSelectionForeground': '#e6edf3',
    'minimapSlider.activeBackground': '#8b949e',
    'minimapSlider.background': '#8b949e',
    'minimapSlider.hoverBackground': '#8b949e',
    ...
    'statusBar.focusBorder': '#1f6feb',
    'statusBar.foreground': '#7d8590',
    'statusBar.noFolderBackground': '#0d1117',
    'statusBarItem.activeBackground': '#e6edf3',
    'statusBarItem.focusBorder': '#1f6feb',
    'statusBarItem.hoverBackground': '#e6edf3',
    'statusBarItem.prominentBackground': '#6e7681',
    ...
    'tab.unfocusedHoverBackground': '#6e7681',
    ...
    'textCodeBlock.background': '#6e7681',
    'textLink.activeForeground': '#2f81f7',
    'textLink.foreground': '#2f81f7',
    'textPreformat.background': '#6e7681',
