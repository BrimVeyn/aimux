...
export const theme: Theme = {
  ...
  colors: {
    ...
    'diffEditor.insertedLineBackground': '#e9e7ba',
    'diffEditor.insertedTextBackground': '#6ec398',
    'diffEditor.removedLineBackground': '#fcd9c9',
    'diffEditor.removedTextBackground': '#f1706f',
    'dropdown.background': '#fdf6e3',
    'dropdown.border': '#e0dcc7',
    'dropdown.foreground': '#879686',
    'editor.background': '#fdf6e3',
    'editor.findMatchBackground': '#f39459',
    'editor.findMatchHighlightBackground': '#a4bb4a',
    'editor.findRangeHighlightBackground': '#e6e2cc',
    'editor.foldBackground': '#e0dcc7',
    'editor.foreground': '#5c6a72',
    'editor.hoverHighlightBackground': '#e6e2cc',
    'editor.inactiveSelectionBackground': '#e6e2cc',
    'editor.lineHighlightBackground': '#efebd4',
    'editor.lineHighlightBorder': '#e0dcc7',
    'editor.rangeHighlightBackground': '#efebd4',
    'editor.selectionBackground': '#e6e2cc',
    'editor.selectionHighlightBackground': '#e6e2cc',
    'editor.snippetFinalTabstopHighlightBackground': '#a4bb4a',
    'editor.snippetFinalTabstopHighlightBorder': '#fdf6e3',
    'editor.snippetTabstopHighlightBackground': '#efebd4',
    'editor.symbolHighlightBackground': '#6cb3c6',
    'editor.wordHighlightBackground': '#e6e2cc',
    'editor.wordHighlightStrongBackground': '#e6e2cc',
    ...
    'editorBracketMatch.border': '#fdf6e3',
    'editorCodeLens.foreground': '#a4ad9e',
    'editorCursor.foreground': '#5c6a72',
    'editorError.background': '#f1706f',
    'editorError.foreground': '#f1706f',
    'editorGhostText.background': '#fdf6e3',
    'editorGhostText.foreground': '#a4ad9e',
    'editorGroup.border': '#efebd4',
    'editorGroup.dropBackground': '#e0dcc7',
    'editorGroupHeader.noTabsBackground': '#fdf6e3',
    'editorGroupHeader.tabsBackground': '#fdf6e3',
    'editorGutter.addedBackground': '#a4bb4a',
    'editorGutter.background': '#fdf6e3',
    'editorGutter.commentRangeForeground': '#a4ad9e',
    'editorGutter.deletedBackground': '#f1706f',
    'editorGutter.modifiedBackground': '#6cb3c6',
    'editorHint.foreground': '#e092be',
    'editorHoverWidget.background': '#f4f0d9',
    'editorHoverWidget.border': '#e6e2cc',
    'editorIndentGuide.activeBackground': '#879686',
    'editorIndentGuide.background': '#879686',
    'editorInfo.background': '#6cb3c6',
    'editorInfo.foreground': '#6cb3c6',
    'editorInlayHint.background': '#fdf6e3',
    'editorInlayHint.foreground': '#a4ad9e',
    'editorInlayHint.parameterBackground': '#fdf6e3',
    'editorInlayHint.parameterForeground': '#a4ad9e',
    'editorInlayHint.typeBackground': '#fdf6e3',
    'editorInlayHint.typeForeground': '#a4ad9e',
    'editorLightBulb.foreground': '#dfa000',
    'editorLightBulbAutoFix.foreground': '#35a77c',
    'editorLineNumber.activeForeground': '#879686',
    'editorLineNumber.foreground': '#a4ad9e',
    'editorLink.activeForeground': '#8da101',
    'editorMarkerNavigation.background': '#f4f0d9',
    'editorMarkerNavigationError.background': '#f1706f',
    'editorMarkerNavigationInfo.background': '#6cb3c6',
    'editorMarkerNavigationWarning.background': '#e4b649',
    'editorOverviewRuler.addedForeground': '#a4bb4a',
    ...
    'editorOverviewRuler.deletedForeground': '#f1706f',
    ...
    'editorOverviewRuler.modifiedForeground': '#6cb3c6',
    ...
    'editorWarning.background': '#e4b649',
    ...
    'extensionButton.prominentHoverBackground': '#93b259',
    ...
    'gitDecoration.stageDeletedResourceForeground': '#35a77c',
    'gitDecoration.stageModifiedResourceForeground': '#35a77c',
    'gitDecoration.submoduleResourceForeground': '#f57d26',
    'gitDecoration.untrackedResourceForeground': '#dfa000',
    ...
    'issues.open': '#35a77c',
    'keybindingLabel.background': '#fdf6e3',
    ...
    'merge.border': '#fdf6e3',
    'merge.currentContentBackground': '#6cb3c6',
    'merge.currentHeaderBackground': '#6cb3c6',
    'merge.incomingContentBackground': '#6ec398',
    'merge.incomingHeaderBackground': '#6ec398',
    'minimap.errorHighlight': '#f1706f',
    'minimap.findMatchHighlight': '#6ec398',
    'minimap.selectionHighlight': '#e0dcc7',
    'minimap.warningHighlight': '#e4b649',
    'minimapGutter.addedBackground': '#a4bb4a',
    'minimapGutter.deletedBackground': '#f1706f',
    'minimapGutter.modifiedBackground': '#6cb3c6',
    ...
    'panelTitle.activeBorder': '#93b259',
    ...
    'peekViewEditor.matchHighlightBackground': '#e4b649',
    ...
    'peekViewResult.matchHighlightBackground': '#e4b649',
    'peekViewResult.selectionBackground': '#6ec398',
    ...
    'rust_analyzer.inlayHints.background': '#fdf6e3',
    'rust_analyzer.inlayHints.foreground': '#a4ad9e',
    'rust_analyzer.syntaxTreeBorder': '#f85552',
    'sash.hoverBorder': '#e6e2cc',
    'scrollbar.shadow': '#3c474d',
    'scrollbarSlider.activeBackground': '#879686',
    'scrollbarSlider.background': '#e0dcc7',
    'scrollbarSlider.hoverBackground': '#e0dcc7',
    'selection.background': '#e6e2cc',
    ...
    'textLink.activeForeground': '#8da101',
