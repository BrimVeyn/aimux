...
export const theme: Theme = {
  ...
  colors: {
    ...
    'diffEditor.diagonalFill': '#817c9c',
    ...
    'editor.findMatchHighlightBackground': '#817c9c',
    'editor.findMatchHighlightForeground': '#e0def4',
    'editor.findRangeHighlightBackground': '#817c9c',
    'editor.findRangeHighlightBorder': '#000',
    'editor.focusedStackFrameHighlightBackground': '#817c9c',
    'editor.foldBackground': '#817c9c',
    'editor.foreground': '#e0def4',
    'editor.hoverHighlightBackground': '#000',
    'editor.inactiveSelectionBackground': '#817c9c',
    'editor.inlineValuesBackground': '#000',
    'editor.inlineValuesForeground': '#908caa',
    'editor.lineHighlightBackground': '#817c9c',
    'editor.lineHighlightBorder': '#000',
    'editor.linkedEditingBackground': '#817c9c',
    'editor.rangeHighlightBackground': '#817c9c',
    'editor.selectionBackground': '#817c9c',
    'editor.selectionForeground': '#e0def4',
    'editor.selectionHighlightBackground': '#817c9c',
    'editor.selectionHighlightBorder': '#232136',
    'editor.snippetFinalTabstopHighlightBackground': '#817c9c',
    'editor.snippetFinalTabstopHighlightBorder': '#2a273f',
    'editor.snippetTabstopHighlightBackground': '#817c9c',
    'editor.snippetTabstopHighlightBorder': '#2a273f',
    'editor.stackFrameHighlightBackground': '#817c9c',
    'editor.symbolHighlightBackground': '#817c9c',
    'editor.symbolHighlightBorder': '#000',
    'editor.wordHighlightBackground': '#817c9c',
    'editor.wordHighlightBorder': '#000',
    'editor.wordHighlightStrongBackground': '#817c9c',
    'editor.wordHighlightStrongBorder': '#817c9c',
    'editorBracketHighlight.foreground1': '#eb6f92',
    'editorBracketHighlight.foreground2': '#3e8fb0',
    'editorBracketHighlight.foreground3': '#f6c177',
    'editorBracketHighlight.foreground4': '#9ccfd8',
    'editorBracketHighlight.foreground5': '#ea9a97',
    ...
    'editorBracketPairGuide.background1': '#3e8fb0',
    'editorBracketPairGuide.background2': '#ea9a97',
    ...
    'editorIndentGuide.background1': '#817c9c',
    ...
    'editorOverviewRuler.border': '#817c9c',
    ...
    'editorOverviewRuler.commonContentForeground': '#817c9c',
    'editorOverviewRuler.currentContentForeground': '#817c9c',
    'editorOverviewRuler.deletedForeground': '#eb6f92',
    'editorOverviewRuler.errorForeground': '#eb6f92',
    'editorOverviewRuler.findMatchForeground': '#817c9c',
    'editorOverviewRuler.incomingContentForeground': '#c4a7e7',
    'editorOverviewRuler.infoForeground': '#9ccfd8',
    'editorOverviewRuler.modifiedForeground': '#ea9a97',
    'editorOverviewRuler.rangeHighlightForeground': '#817c9c',
    'editorOverviewRuler.selectionHighlightForeground': '#817c9c',
    'editorOverviewRuler.warningForeground': '#f6c177',
    'editorOverviewRuler.wordHighlightForeground': '#817c9c',
    'editorOverviewRuler.wordHighlightStrongForeground': '#817c9c',
    'editorPane.background': '#000',
    'editorRuler.foreground': '#817c9c',
    ...
    'editorSuggestWidget.selectedBackground': '#817c9c',
    ...
    'extensionButton.prominentHoverBackground': '#ea9a97',
    ...
    'list.focusBackground': '#817c9c',
    'list.focusForeground': '#e0def4',
    'list.focusOutline': '#817c9c',
    'list.highlightForeground': '#ea9a97',
    'list.hoverBackground': '#817c9c',
    'list.hoverForeground': '#e0def4',
    'list.inactiveFocusBackground': '#817c9c',
    ...
    'menu.selectionBackground': '#817c9c',
    'menu.selectionBorder': '#393552',
    'menu.selectionForeground': '#e0def4',
    'menu.separatorBackground': '#817c9c',
    'menubar.selectionBackground': '#817c9c',
    'menubar.selectionBorder': '#817c9c',
    'menubar.selectionForeground': '#e0def4',
    'merge.border': '#393552',
    'merge.commonContentBackground': '#817c9c',
    'merge.commonHeaderBackground': '#817c9c',
    ...
    'minimap.findMatchHighlight': '#817c9c',
    'minimap.selectionHighlight': '#817c9c',
    ...
    'minimapSlider.activeBackground': '#817c9c',
    'minimapSlider.background': '#817c9c',
    'minimapSlider.hoverBackground': '#817c9c',
    'notebook.cellBorderColor': '#9ccfd8',
    'notebook.cellEditorBackground': '#2a273f',
    'notebook.cellHoverBackground': '#393552',
    'notebook.focusedCellBackground': '#817c9c',
    'notebook.focusedCellBorder': '#9ccfd8',
    'notebook.outputContainerBackgroundColor': '#817c9c',
    'notificationCenter.border': '#817c9c',
    'notificationCenterHeader.background': '#2a273f',
    'notificationCenterHeader.foreground': '#908caa',
    'notificationLink.foreground': '#c4a7e7',
    'notificationToast.border': '#817c9c',
    'notifications.background': '#2a273f',
    'notifications.border': '#817c9c',
    ...
    'quickInputList.focusBackground': '#817c9c',
    'quickInputList.focusForeground': '#e0def4',
    'quickInputList.focusIconForeground': '#e0def4',
    'scrollbar.shadow': '#2a273f',
    'scrollbarSlider.activeBackground': '#3e8fb0',
    'scrollbarSlider.background': '#817c9c',
    'scrollbarSlider.hoverBackground': '#817c9c',
    'searchEditor.findMatchBackground': '#817c9c',
    'selection.background': '#817c9c',
    'settings.focusedRowBackground': '#2a273f',
    'settings.focusedRowBorder': '#817c9c',
    ...
    'sideBarSectionHeader.border': '#817c9c',
    ...
    'terminal.dropBackground': '#817c9c',
    'terminal.foreground': '#e0def4',
    'terminal.selectionBackground': '#817c9c',
